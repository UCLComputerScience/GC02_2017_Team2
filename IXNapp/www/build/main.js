...
GroupListPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-group-list',template:/*ion-inline-start:"/Users/sophia/Google Drive/Ionic/IXNapp/src/pages/group-list/group-list.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Group List\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding id="page3">\n  <div id="groupList-container1">\n    <button id="groupList-button3" ion-button color="balanced" on-click="goToFeedbackSummary()">\n      Group 1 - Project Stage\n    </button>\n    <button id="groupList-button8" ion-button clear color="positive" style="color:#00A8FF;text-align:left;border-radius:3px 3px 3px 3px;" on-click="goToGroup()">\n      <ion-icon name="add-circle"></ion-icon>\n    </button>\n  </div>\n  <div id="groupList-container2">\n    <div class="spacer" style="width:300px;height:15px;" id="groupList-spacer7"></div>\n    <button id="groupList-button9" ion-button color="assertive" on-click="goToFeedbackSummary()">\n      Group 2 - Project Stage\n    </button>\n    <button id="groupList-button10" ion-button clear color="positive" style="color:#00A8FF;text-align:left;border-radius:3px 3px 3px 3px;" on-click="goToGroup()">\n      <ion-icon name="add-circle"></ion-icon>\n    </button>\n    <div class="spacer" style="width:300px;height:15px;" id="groupList-spacer8"></div>\n  </div>\n  <div id="groupList-container5">\n    <button id="groupList-button15" ion-button color="energized" on-click="goToFeedbackSummary()">\n      Group 3 - Project Stage\n    </button>\n    <button id="groupList-button16" ion-button clear color="positive" style="color:#00A8FF;text-align:left;border-radius:3px 3px 3px 3px;" on-click="goToGroup()">\n      <ion-icon name="add-circle"></ion-icon>\n    </button>\n  </div>\n  <div class="spacer" style="width:300px;height:15px;" id="groupList-spacer6"></div>\n</ion-content>'/*ion-inline-end:"/Users/sophia/Google Drive/Ionic/IXNapp/src/pages/group-list/group-list.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */]])
], GroupListPage);
...
StaffContactInfoPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-staff-contact-info',template:/*ion-inline-start:"/Users/sophia/Google Drive/Ionic/IXNapp/src/pages/staff-contact-info/staff-contact-info.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Staff Contact Info\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding id="page6">\n  <h4 id="staffContactInfo-heading2" style="color:#000000;">\n    Lecturers\n  </h4>\n  <ion-list id="staffContactInfo-list3">\n    <ion-item color="none" id="staffContactInfo-list-item15">\n      <ion-avatar item-left>\n        <img />\n      </ion-avatar>\n      <h2>\n        Firstname Lastname\n      </h2>\n    </ion-item>\n  </ion-list>\n  <h4 id="staffContactInfo-heading3" style="color:#000000;">\n    TAs\n  </h4>\n  <ion-list id="staffContactInfo-list6">\n    <ion-item color="none" id="staffContactInfo-list-item28">\n      <ion-avatar item-left>\n        <img />\n      </ion-avatar>\n      <h2>\n        Firstname Lastname\n      </h2>\n    </ion-item>\n    <ion-item color="none" id="staffContactInfo-list-item29">\n      <ion-avatar item-left>\n        <img />\n      </ion-avatar>\n      <h2>\n        Firstname Lastname\n      </h2>\n    </ion-item>\n    <ion-item color="none" id="staffContactInfo-list-item30">\n      <ion-avatar item-left>\n        <img />\n      </ion-avatar>\n      <h2>\n        Firstname Lastname\n      </h2>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"/Users/sophia/Google Drive/Ionic/IXNapp/src/pages/staff-contact-info/staff-contact-info.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */]])
...
MyProfilePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-my-profile',template:/*ion-inline-start:"/Users/sophia/Google Drive/Ionic/IXNapp/src/pages/my-profile/my-profile.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      My Profile\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding id="page4">\n  <img src="assets/img/iPJmfKWCSdylgevYCJ6t_myAvatar3.png" style="display:block;width:80px;height:80px;margin-left:auto;margin-right:auto;" />\n  <form id="myProfile-form3">\n    <div class="spacer" style="height:40px;" id="myProfile-spacer2"></div>\n    <ion-item id="myProfile-input1">\n      <ion-label></ion-label>\n      <ion-input type="text" placeholder="Firstname"></ion-input>\n    </ion-item>\n    <ion-item id="myProfile-input2">\n      <ion-label floating></ion-label>\n      <ion-input type="text" placeholder="Lastname"></ion-input>\n    </ion-item>\n    <ion-item id="myProfile-input3">\n      <ion-label></ion-label>\n      <ion-input type="email" placeholder="Email"></ion-input>\n    </ion-item>\n    <ion-item id="myProfile-input4">\n      <ion-label></ion-label>\n      <ion-input type="password" placeholder="Password"></ion-input>\n    </ion-item>\n  </form>\n  <h4 id="myProfile-heading1" style="color:#000000;text-align:center;">\n    Supervising groups\n  </h4>\n  <div id="myProfile-container19">\n    <button id="myProfile-button25" ion-button color="positive" style="border-radius:70px 70px 70px 70px;">\n      G3\n    </button>\n    <button id="myProfile-button24" ion-button color="positive" style="border-radius:70px 70px 70px 70px;">\n      G1\n    </button>\n    <button id="myProfile-button26" ion-button color="positive" style="border-radius:70px 70px 70px 70px;">\n      G5\n    </button>\n  </div>\n</ion-content>'/*ion-inline-end:"/Users/sophia/Google Drive/Ionic/IXNapp/src/pages/my-profile/my-profile.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */]])
], MyProfilePage);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/sophia/Google Drive/Ionic/IXNapp/src/app/app.html"*/'<ion-nav #mainContent [root]="rootPage"></ion-nav>'/*ion-inline-end:"/Users/sophia/Google Drive/Ionic/IXNapp/src/app/app.html"*/
    }),
